...
// Device formats → base body dimensions (px). Widths align with the old size
// scale (sm 240 / md 320 / lg 400) so sizing stays consistent.
export var FORMATS: Record<string, { width: number; height: number }> = {
  ...
  square: { width: 320, height: 320 },  // md width, 1:1
};
